...
python train_dsf_marianmt_full_real.py --data translation.csv --run_dsf --epochs 10

Transformer baselines:

python train_dsf_marianmt_full_real.py --data translation.csv --run_transformers --epochs 10

Classical baselines:

python train_dsf_marianmt_full_real.py --data translation.csv --run_classic --epochs 10

Complete pipeline:

python train_dsf_marianmt_full_real.py --data translation.csv --run_all --epochs 10
...
Dataset partitions, predictions, checkpoints, and evaluation results are saved automatically.
